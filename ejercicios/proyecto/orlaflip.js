...
function mostrarImagen() {
    ...
    for (i = 0; i < registrados.length; i++) {
       ...
       detalle= registrados[i][3];
            // actualizo la tabla de visualización
            bloque += "<div class=\"flip-box\"><div class=\"flip-box-inner\"><div class=\"flip-box-front\"> <img src='" + foto + "' alt='" + pie + "'/><div id='pie' class='pie'><p >" + pie + "</p></div></div><div class=\"flip-box-back\">"+detalle+"</div></div></div>";
