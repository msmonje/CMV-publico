...
function ascNombre() {
    ...
    registrados.sort(
        (usuario1, usuario2) =>
            usuario1[0].localeCompare(usuario2[0]), //[0] = nombre
    );
    mostrar();
}
...
//  function mostrarClave (){
//   let dato=$("usuario").val().toUpperCase(); //obtener datointroducido por teclado
//   let pwd =null;

//   for(i=0;i<registrados.length;i++){
//     if(registrados[i][0]==dato){
//       pwd=registrados[i][1];
//       document.getElementById("clave").innerHTML = pwd;
//       break;
//     }
//     else{
//       document.getElementById("clave").innerHTML = "Usuario no existe";
//     }
